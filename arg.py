...
def get_parser():
    ...
    parser.add_argument('--dataset', type=str, default='cora_full', choices=['Cora', 'CiteSeer', 'cora_full','pubmed','computers','photo','cs'])
    ...
    if not parser.parse_known_args()[0].baseline:
        ...
        parser.add_argument('--rec', type=str2bool, default=True, help="Whether to include edge reconstruction")
        ...
        parser.add_argument('--class_weight', type=str2bool, default=False, help="Wheter to apply inverse cardinality as a class weight.") # key hyperparameter
